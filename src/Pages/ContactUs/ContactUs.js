...
export default function ContactUs() {
  ...
  const getSearchQueryLink = (placeLink) => {
    ...
    if (!placeLink.includes("&z=")) {
      return `${placeLink}&z=20`; // Zoom level set to 17
    }
